...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		if ( (session.getAttribute("uname") == null && (requestPath.endsWith("index.jsp")))||(session.getAttribute("uname") == null && (requestPath.endsWith("alreadyBuy.jsp")
						|| requestPath.endsWith("shoppingCart.jsp") 
						|| requestPath.endsWith("addToCart.jsp") 
