...
<script type="text/javascript">
	function editInfo() {
		if (document.getElementById("submit").value == "Edit information") {
			document.getElementById("Email").disabled = false;
			document.getElementById("Password").disabled = false;
			document.getElementById("submit").value = "Sure to change";
			return false;
		}
		return true;
	}
		...
		<form id="registForm" action="servlet/EditInfoServlet" method="get">
			<ol>
				<%
					...
					User user = dao.queryByName(uname,identity);
					if (user != null) {

					}
				%>

				<li><label for="UserName">User： <span
				...
				<li><label for="Email">Email： <span
						...
						rules="[{notNull:true, message:'Can not be empty'},{isEmail:true,message:'电子邮件格式不正确'}]"></span>
				...
				<li><label for="Password">Password： <span
						...
						rules="[{notNull:true, message:'Can not be empty'},{minLength:'6',message:'密码长度最少为6位'}]"></span>
				...
				<li><label for="email">LastLoginTime： </label> <input id="email"
